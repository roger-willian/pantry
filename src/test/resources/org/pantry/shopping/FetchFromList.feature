@Shopping @ShoppingCart @ShoppingList @Interface @Database
  Feature: Fetch from list

    Fetch a product from the shopping list to the shopping cart
    ...
    Scenario: A whole item
      ...
      Fetch an item's entire quantity from the list.
    ...
    Scenario: More than a whole item

      Fetch more than an item's entire quantity from the list.
    ...
    Scenario: Part of an item
      ...
      Fetch less than an item's entire quantity from the list.
    ...
    Scenario: Item already fetched

      Fetch part of an item from the list that is in the shopping cart already.
    ...
    Scenario Outline: Invalid product
      ...
      Try to fetch an invalid item from the list.
